...
export default function About() {
  return (
    <section className=" gap-10 md:gap-20 flex md:flex-row flex-col mt-20 text-center justify-center items-center-full mx-auto px-2 md:flex place-items-center ">
      <div>
        <img
          loading="lazy"
